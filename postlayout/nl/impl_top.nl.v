module impl_top (clk,
 ...
 wire \i_uart_rx.cycle_counter[12] ;
 wire \i_uart_rx.cycle_counter[13] ;
 ...
 wire \i_uart_tx.cycle_counter[12] ;
 wire \i_uart_tx.cycle_counter[13] ;
 ...
 sky130_fd_sc_hd__inv_2 _244_ (.A(net43),
    .Y(_081_));
 sky130_fd_sc_hd__inv_2 _245_ (.A(\i_uart_rx.uart_rx_data[0] ),
    .Y(_082_));
 ...
 sky130_fd_sc_hd__inv_2 _249_ (.A(net118),
    .Y(_086_));
 sky130_fd_sc_hd__or2_1 _250_ (.A(\i_uart_rx.cycle_counter[1] ),
    .B(\i_uart_rx.cycle_counter[0] ),
    .X(_087_));
 sky130_fd_sc_hd__or4b_1 _251_ (.A(\i_uart_rx.cycle_counter[13] ),
    .B(\i_uart_rx.cycle_counter[12] ),
    .C(\i_uart_rx.cycle_counter[10] ),
    .D_N(\i_uart_rx.cycle_counter[11] ),
    .X(_088_));
 sky130_fd_sc_hd__and2_1 _252_ (.A(net61),
    .B(net89),
    .X(_089_));
 sky130_fd_sc_hd__nand4b_1 _253_ (.A_N(\i_uart_rx.cycle_counter[4] ),
    .B(net61),
    .C(\i_uart_rx.cycle_counter[2] ),
    .D(\i_uart_rx.cycle_counter[5] ),
    .Y(_090_));
 sky130_fd_sc_hd__or4b_1 _254_ (.A(\i_uart_rx.cycle_counter[8] ),
 ...
 sky130_fd_sc_hd__or4_2 _255_ (.A(_087_),
    ...
    .D(_091_),
    .X(_092_));
 sky130_fd_sc_hd__nand2_1 _256_ (.A(\i_uart_rx.cycle_counter[4] ),
    .B(net61),
    .Y(_093_));
 sky130_fd_sc_hd__or4b_1 _257_ (.A(\i_uart_rx.cycle_counter[13] ),
    .B(\i_uart_rx.cycle_counter[1] ),
    .C(\i_uart_rx.cycle_counter[0] ),
    .D_N(\i_uart_rx.cycle_counter[12] ),
    .X(_094_));
 sky130_fd_sc_hd__or4b_1 _258_ (.A(\i_uart_rx.cycle_counter[7] ),
    .B(\i_uart_rx.cycle_counter[5] ),
    .C(\i_uart_rx.cycle_counter[2] ),
    .D_N(\i_uart_rx.cycle_counter[6] ),
    .X(_095_));
 sky130_fd_sc_hd__or4b_1 _259_ (.A(\i_uart_rx.cycle_counter[11] ),
    .B(\i_uart_rx.cycle_counter[9] ),
    .C(\i_uart_rx.cycle_counter[8] ),
    .D_N(\i_uart_rx.cycle_counter[10] ),
    .X(_096_));
 sky130_fd_sc_hd__or4_2 _260_ (.A(_093_),
    ...
    .D(_096_),
    .X(_097_));
 sky130_fd_sc_hd__or4bb_1 _261_ (.A(\i_uart_rx.cycle_counter[13] ),
    .B(\i_uart_rx.cycle_counter[12] ),
    .C_N(net61),
    .D_N(\i_uart_rx.cycle_counter[2] ),
    .X(_098_));
 sky130_fd_sc_hd__or4b_1 _262_ (.A(\i_uart_rx.cycle_counter[7] ),
    .B(\i_uart_rx.cycle_counter[6] ),
    .C(\i_uart_rx.cycle_counter[4] ),
    .D_N(\i_uart_rx.cycle_counter[5] ),
    .X(_099_));
 sky130_fd_sc_hd__or4bb_1 _263_ (.A(\i_uart_rx.cycle_counter[5] ),
    .B(\i_uart_rx.cycle_counter[2] ),
    .C_N(\i_uart_rx.cycle_counter[3] ),
    .D_N(\i_uart_rx.cycle_counter[4] ),
    .X(_100_));
 sky130_fd_sc_hd__or4bb_1 _264_ (.A(\i_uart_rx.cycle_counter[10] ),
 ...
 sky130_fd_sc_hd__nor4_1 _265_ (.A(_087_),
    ...
    .D(_101_),
    .Y(_102_));
 sky130_fd_sc_hd__or4bb_1 _266_ (.A(\i_uart_rx.cycle_counter[13] ),
    .B(\i_uart_rx.cycle_counter[11] ),
    .C_N(\i_uart_rx.cycle_counter[10] ),
    .D_N(\i_uart_rx.cycle_counter[12] ),
    .X(_103_));
 sky130_fd_sc_hd__or4b_1 _267_ (.A(\i_uart_rx.cycle_counter[9] ),
    .B(\i_uart_rx.cycle_counter[8] ),
 ...
 sky130_fd_sc_hd__or4b_1 _284_ (.A(net129),
    ...
    .D_N(\i_uart_tx.bit_counter[0] ),
    .X(_119_));
 sky130_fd_sc_hd__inv_2 _285_ (.A(_119_),
    .Y(_120_));
 sky130_fd_sc_hd__a221o_1 _286_ (.A1(\i_uart_tx.fsm_state[0] ),
    .A2(_118_),
    .B1(_120_),
    .B2(net124),
    .C1(_084_),
    .X(_004_));
 sky130_fd_sc_hd__or4b_1 _287_ (.A(\i_uart_rx.bit_counter[2] ),
    .B(net122),
 ...
 sky130_fd_sc_hd__a31o_1 _294_ (.A1(net12),
    ...
    .B1(_125_),
    .X(_007_));
 sky130_fd_sc_hd__and2_2 _295_ (.A(\i_uart_tx.fsm_state[0] ),
    .B(_117_),
    .X(_126_));
 sky130_fd_sc_hd__nand2_2 _296_ (.A(\i_uart_tx.fsm_state[0] ),
    .B(_117_),
    .Y(_127_));
 ...
 sky130_fd_sc_hd__o211a_1 _307_ (.A1(net71),
    ...
    .C1(net12),
    .X(_011_));
 sky130_fd_sc_hd__a21o_1 _308_ (.A1(\i_uart_rx.uart_rx_data[4] ),
    .A2(_117_),
    .B1(_084_),
    .X(_133_));
 sky130_fd_sc_hd__a21o_1 _309_ (.A1(net18),
    ...
    .B1(_133_),
    .X(_012_));
 sky130_fd_sc_hd__a21o_1 _310_ (.A1(\i_uart_rx.uart_rx_data[5] ),
    .A2(_117_),
    .B1(_084_),
    .X(_134_));
 sky130_fd_sc_hd__a21o_1 _311_ (.A1(net16),
    ...
    .B1(_134_),
    .X(_013_));
 sky130_fd_sc_hd__a21o_1 _312_ (.A1(\i_uart_rx.uart_rx_data[6] ),
    .A2(_117_),
    .B1(_084_),
    .X(_135_));
 sky130_fd_sc_hd__a21o_1 _313_ (.A1(net22),
    ...
    .B1(_135_),
    .X(_014_));
 sky130_fd_sc_hd__a21o_1 _314_ (.A1(\i_uart_rx.uart_rx_data[7] ),
    .A2(_117_),
    .B1(_084_),
    .X(_136_));
 ...
 sky130_fd_sc_hd__o211a_1 _325_ (.A1(net60),
    ...
    .C1(net12),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _326_ (.A0(\i_uart_tx.data_to_send[4] ),
    .A1(net79),
    .S(_137_),
    .X(_144_));
 ...
 sky130_fd_sc_hd__o211a_1 _328_ (.A1(net71),
    ...
    .C1(net12),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _329_ (.A0(\i_uart_tx.data_to_send[5] ),
 ...
 sky130_fd_sc_hd__o211a_1 _331_ (.A1(net65),
    ...
    .C1(net12),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _332_ (.A0(\i_uart_tx.data_to_send[6] ),
 ...
 sky130_fd_sc_hd__o211a_1 _334_ (.A1(net87),
    ...
    .C1(net12),
    .X(_021_));
 sky130_fd_sc_hd__a22o_1 _335_ (.A1(\i_uart_tx.fsm_state[0] ),
    .A2(_117_),
    .B1(_137_),
    .B2(\i_uart_tx.data_to_send[6] ),
    .X(_150_));
 sky130_fd_sc_hd__o211a_1 _336_ (.A1(\i_uart_rx.uart_rx_data[6] ),
    .A2(_127_),
    .B1(_150_),
    .C1(net13),
    .X(_151_));
 sky130_fd_sc_hd__and3_1 _337_ (.A(\i_uart_tx.data_to_send[7] ),
    .B(net13),
    .C(_127_),
    .X(_152_));
 sky130_fd_sc_hd__a31o_1 _338_ (.A1(net118),
    ...
    .B1(_151_),
    .X(_022_));
 sky130_fd_sc_hd__or2_1 _339_ (.A(\i_uart_rx.fsm_state[3] ),
 ...
 sky130_fd_sc_hd__o211a_1 _359_ (.A1(net70),
    ...
    .C1(_164_),
    .X(_031_));
 sky130_fd_sc_hd__or2_1 _360_ (.A(\i_uart_rx.recieved_data[1] ),
    .B(_161_),
    .X(_165_));
 ...
 sky130_fd_sc_hd__o211a_1 _369_ (.A1(net67),
    ...
    .C1(_169_),
    .X(_036_));
 sky130_fd_sc_hd__or2_1 _370_ (.A(\i_uart_rx.recieved_data[6] ),
    .B(_161_),
    .X(_170_));
 sky130_fd_sc_hd__o211a_1 _371_ (.A1(net39),
    ...
    .C1(_170_),
    .X(_037_));
 sky130_fd_sc_hd__or2_1 _372_ (.A(\i_uart_rx.recieved_data[7] ),
    .B(_161_),
    .X(_171_));
 ...
 sky130_fd_sc_hd__and3_1 _383_ (.A(_172_),
    ...
    .C(_178_),
    .X(_041_));
 sky130_fd_sc_hd__a21o_1 _384_ (.A1(\i_uart_rx.bit_counter[2] ),
    .A2(_176_),
    .B1(net115),
    .X(_179_));
 ...
 sky130_fd_sc_hd__and3_1 _481_ (.A(_128_),
    ...
    .C(_240_),
    .X(_077_));
 sky130_fd_sc_hd__a31o_1 _482_ (.A1(\i_uart_tx.cycle_counter[12] ),
    .A2(net53),
    .A3(_236_),
    .B1(net109),
    .X(_241_));
 ...
 sky130_fd_sc_hd__dfxtp_1 _563_ (.CLK(clknet_3_4__leaf_clk),
    .D(net159),
    .Q(\i_uart_tx.cycle_counter[12] ));
 sky130_fd_sc_hd__dfxtp_1 _564_ (.CLK(clknet_3_4__leaf_clk),
    .D(net110),
    .Q(\i_uart_tx.cycle_counter[13] ));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\i_uart_rx.rxd_reg_0 ),
    .X(net14));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold10 (.A(_014_),
    .X(net23));
 sky130_fd_sc_hd__dlygate4sd3_1 hold11 (.A(\i_uart_rx.recieved_data[0] ),
    .X(net24));
 sky130_fd_sc_hd__dlygate4sd3_1 hold12 (.A(_023_),
    .X(net25));
 sky130_fd_sc_hd__dlygate4sd3_1 hold13 (.A(\i_uart_rx.bit_sample ),
    .X(net26));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(_015_),
    .X(net29));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\i_uart_tx.cycle_counter[1] ),
    .X(net30));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(_066_),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(\i_uart_rx.uart_rx_data[7] ),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(_060_),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(\i_uart_rx.rxd_reg ),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(_000_),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold23 (.A(\i_uart_tx.cycle_counter[7] ),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold24 (.A(_232_),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold25 (.A(_072_),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold26 (.A(\i_uart_rx.recieved_data[7] ),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold27 (.A(_037_),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(\i_uart_tx.cycle_counter[8] ),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(_073_),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(\i_uart_rx.fsm_state[3] ),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\i_uart_rx.recieved_data[5] ),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(_028_),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\i_uart_rx.recieved_data[4] ),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(_027_),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\i_uart_rx.fsm_state[0] ),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(_035_),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\i_uart_rx.recieved_data[3] ),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(_167_),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(_034_),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\i_uart_tx.cycle_counter[11] ),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(_076_),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\i_uart_tx.cycle_counter[10] ),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(_237_),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_075_),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\i_uart_rx.recieved_data[2] ),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(_032_),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\i_uart_rx.uart_rx_data[2] ),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\i_uart_rx.cycle_counter[3] ),
    .X(net61));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(_043_),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\i_uart_rx.uart_rx_data[4] ),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(_020_),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\i_uart_rx.recieved_data[6] ),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(_029_),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\i_uart_rx.fsm_state[1] ),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\i_uart_rx.recieved_data[1] ),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\i_uart_rx.uart_rx_data[3] ),
    .X(net71));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(_010_),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\i_uart_rx.uart_rx_data[1] ),
    .X(net75));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(_011_),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\i_uart_tx.data_to_send[3] ),
    .X(net79));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(_019_),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\i_uart_tx.data_to_send[2] ),
    .X(net83));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(_018_),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\i_uart_rx.uart_rx_data[5] ),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(_021_),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\i_uart_rx.cycle_counter[2] ),
    .X(net89));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(_009_),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\i_uart_tx.cycle_counter[5] ),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(_228_),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(_070_),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\i_uart_tx.cycle_counter[6] ),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(_230_),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(_071_),
    .X(net99));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\i_uart_rx.cycle_counter[1] ),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(_185_),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(_045_),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\i_uart_rx.cycle_counter[12] ),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(_056_),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\i_uart_tx.data_to_send[1] ),
    .X(net105));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(_017_),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\i_uart_tx.cycle_counter[13] ),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(_078_),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\i_uart_tx.cycle_counter[3] ),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(_224_),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(_068_),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\i_uart_rx.fsm_state[2] ),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\i_uart_rx.bit_counter[3] ),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(_180_),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(_042_),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\i_uart_tx.fsm_state[1] ),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(_022_),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\i_uart_rx.uart_rx_data[0] ),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(_016_),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\i_uart_rx.bit_counter[1] ),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(_121_),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\i_uart_tx.fsm_state[3] ),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(_004_),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\i_uart_rx.cycle_counter[11] ),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(_204_),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(_055_),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\i_uart_tx.bit_counter[3] ),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(_119_),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(_007_),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\i_uart_rx.cycle_counter[8] ),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(_198_),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(_052_),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\i_uart_rx.bit_counter[0] ),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\i_uart_rx.bit_counter[2] ),
    .X(net136));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(_048_),
    .X(net142));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\i_uart_tx.cycle_counter[2] ),
    .X(net143));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(_221_),
    .X(net144));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(_067_),
    .X(net145));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\i_uart_rx.cycle_counter[10] ),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(_202_),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(_054_),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\i_uart_tx.fsm_state[2] ),
    .X(net149));
 sky130_fd_sc_hd__dlygate4sd3_1 hold137 (.A(_006_),
    .X(net150));
 sky130_fd_sc_hd__dlygate4sd3_1 hold138 (.A(\i_uart_tx.data_to_send[0] ),
    .X(net151));
 sky130_fd_sc_hd__dlygate4sd3_1 hold139 (.A(_242_),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd3_1 hold140 (.A(_079_),
    .X(net153));
 sky130_fd_sc_hd__dlygate4sd3_1 hold141 (.A(\i_uart_rx.cycle_counter[13] ),
    .X(net154));
 sky130_fd_sc_hd__dlygate4sd3_1 hold142 (.A(_207_),
    .X(net155));
 sky130_fd_sc_hd__dlygate4sd3_1 hold143 (.A(_057_),
    .X(net156));
 sky130_fd_sc_hd__dlygate4sd3_1 hold144 (.A(\i_uart_tx.cycle_counter[12] ),
    .X(net157));
 sky130_fd_sc_hd__dlygate4sd3_1 hold145 (.A(_239_),
    .X(net158));
 sky130_fd_sc_hd__dlygate4sd3_1 hold146 (.A(_077_),
    .X(net159));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(\i_uart_tx.cycle_counter[4] ),
    .X(net160));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(_225_),
    .X(net161));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(_069_),
    .X(net162));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(\i_uart_rx.cycle_counter[7] ),
    .X(net163));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(_196_),
    .X(net164));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(_051_),
    .X(net165));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(\i_uart_tx.bit_counter[0] ),
    .X(net166));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(_211_),
    .X(net167));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(_061_),
    .X(net168));
 sky130_fd_sc_hd__dlygate4sd3_1 hold156 (.A(\i_uart_tx.cycle_counter[9] ),
    .X(net169));
 sky130_fd_sc_hd__dlygate4sd3_1 hold157 (.A(_074_),
    .X(net170));
 sky130_fd_sc_hd__dlygate4sd3_1 hold158 (.A(\i_uart_rx.cycle_counter[9] ),
    .X(net171));
 sky130_fd_sc_hd__dlygate4sd3_1 hold159 (.A(_200_),
    .X(net172));
 sky130_fd_sc_hd__dlygate4sd3_1 hold160 (.A(_053_),
    .X(net173));
 sky130_fd_sc_hd__dlygate4sd3_1 hold161 (.A(\i_uart_tx.bit_counter[2] ),
    .X(net174));
 sky130_fd_sc_hd__dlygate4sd3_1 hold162 (.A(_108_),
    .X(net175));
 sky130_fd_sc_hd__dlygate4sd3_1 hold163 (.A(_005_),
    .X(net176));
 sky130_fd_sc_hd__dlygate4sd3_1 hold164 (.A(\i_uart_rx.cycle_counter[6] ),
    .X(net177));
 sky130_fd_sc_hd__dlygate4sd3_1 hold165 (.A(_194_),
    .X(net178));
 sky130_fd_sc_hd__dlygate4sd3_1 hold166 (.A(\i_uart_tx.cycle_counter[0] ),
    .X(net179));
 sky130_fd_sc_hd__dlygate4sd3_1 hold167 (.A(\i_uart_tx.fsm_state[0] ),
    .X(net180));
 sky130_fd_sc_hd__dlygate4sd3_1 hold168 (.A(_064_),
    .X(net181));
 sky130_fd_sc_hd__dlygate4sd3_1 hold169 (.A(\i_uart_tx.bit_counter[1] ),
    .X(net182));
 sky130_fd_sc_hd__dlygate4sd3_1 hold170 (.A(\i_uart_rx.cycle_counter[0] ),
    .X(net183));
